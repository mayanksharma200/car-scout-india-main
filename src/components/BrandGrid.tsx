      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20 space-y-6 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed opacity-80">
            Discover exceptional vehicles from India's most prestigious automotive manufacturers. 
            Experience luxury, performance, and innovation across our curated brand portfolio.
          </p>
        </div>
                        ...
                        {[...Array(5)].map((_, i) => (
                          <Star 
                            ...
                            style={{ 
                              ...
                              animation: brand.rating > i ? 'scale-in 0.3s ease-out' : 'none'
                            }}
                          />
                        ))}
                      </div>
                      <span className="text-sm sm:text-base font-bold text-foreground">{brand.rating}</span>
                    </div>
        ...
        {/* Ultra-modern CTA with advanced effects */}
        <div className="text-center animate-fade-in" style={{ animationDelay: '0.8s' }}>
          <button 
            onClick={handleExploreAllClick}
            className="group relative inline-flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-primary to-accent text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg overflow-hidden shadow-2xl shadow-primary/25 hover:shadow-3xl hover:shadow-primary/40 transition-all duration-500 hover:scale-105 animate-gradient-shift"
