  ...
  hover:bg-white/95 hover:backdrop-blur-2xl hover:shadow-2xl"
          >
            <CardContent className="p-4 md:p-6 lg:p-8 space-y-4 md:space-y-6">
              ...
              <div className="flex flex-wrap gap-2 md:gap-3 justify-center">
                <button
                  className={`px-3 py-2 md:px-4 cursor-pointer transition-colors text-xs md:text-sm rounded-md border ${carType === "new"
                ...
                <button
                  className={`px-3 py-2 md:px-4 cursor-pointer transition-colors text-xs md:text-sm rounded-md border ${carType === "certified"
                    ? "bg-primary text-primary-foreground border-primary"
                    : "bg-background border-border hover:bg-primary hover:text-primary-foreground"
                    }`}
                  onClick={() =>
                ...
                <button
                  className={`px-3 py-2 md:px-4 cursor-pointer transition-colors text-xs md:text-sm rounded-md border ${carType === "premium"
                    ? "bg-primary text-primary-foreground border-primary"
                    : "bg-background border-border hover:bg-primary hover:text-primary-foreground"
                    }`}
                  onClick={() =>
          ...
          transition-all duration-300"
              ...
              <div>
                ...
                <div
                  className={`space-y-6 mt-6 ${showAdvanced ? "block" : "hidden"
                    }`}
                >
                  {/* Sliders */}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {options.map((option) => {
                            ...
                            return (
                              <button
                                key={option}
                                className={`cursor-pointer transition-all hover:scale-105 px-3 py-1 rounded-md text-sm border ${isSelected
                                  ? "bg-primary text-primary-foreground border-primary"
                                  : "bg-background border-border hover:bg-primary hover:text-primary-foreground"
                                  }`}
                                onClick={() => {
