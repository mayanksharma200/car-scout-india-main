        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none dark:prose-invert">
            <section className="mb-8">
              ...
              <p className="mb-4">
                AutoScope is primarily an information and comparison platform for automobiles. 
                As we do not directly sell vehicles, this refund policy applies to any premium 
                services or subscriptions offered on our platform.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                If you have purchased any premium services from AutoScope, you may be eligible 
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                AutoScope does not directly facilitate vehicle sales. Any vehicle purchase 
                transactions are between you and the respective dealer/seller. Refund policies 
                for vehicle purchases are governed by the dealer's terms and conditions.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">Loan and Insurance Services</h2>
              <p className="mb-4">
                For loan applications and insurance policies initiated through our platform, 
                refund policies are governed by the respective financial institutions. 
                AutoScope facilitates these services but does not control their refund terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>Email: refunds@autoscope.com</p>
