        ...
        <Card className="shadow-auto-lg bg-background/95 backdrop-blur-sm border-border">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">
              ...
              {step === "reset" && "Create your new admin password"}
            </p>
          </CardHeader>
            ...
            {step === "email" && (
              <form onSubmit={handleSendOTP} className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    This is the secure admin password reset. Only admin accounts
            ...
            {step === "reset" && (
              <form onSubmit={handleResetPassword} className="space-y-4">
                ...
                <Alert>
                  <Shield className="h-4 w-4" />
                  <AlertDescription>
                    Password must be at least 8 characters long. Use a strong
                    password for admin security.
                  </AlertDescription>
                </Alert>
